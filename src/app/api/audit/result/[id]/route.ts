 ...
 * Devuelve el resultado completo de la auditoría en JSON.
 * Solo funciona si status === "completed".
 */
...
export async function GET(
  ...
  try {
    ...
    if (lead.status !== "completed") {
      return NextResponse.json(
        {
          error: "La auditoría aún no está completa",
          status: lead.status,
        },
    ...
    console.error("[API] GET /api/audit/result error:", error);
    return NextResponse.json(
